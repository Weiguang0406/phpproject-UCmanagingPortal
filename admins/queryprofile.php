...
if ((isset($_GET['user_id'])) && isset($_SESSION['username'])) { //????
    $user_id = $_GET['user_id'];

    $sql = "select s.student_id, studentname, studentemail, studentclass, gender, dob,fathername, mothername, 
            contactnumber, alternatenumber, address, u.username,  date(dateofadmission) as dateofadmission,imagefilename
             from students s
                    ...
                    <table border="1" class="table table-bordered mg-b-0">
                        ...
                        if (!empty($data)) {
                            ...
                            <tr class="table-info">
                                ...
                                <th><?php echo number_format($totalcoursedata['grade'] / $totalcoursedata['course_count'],2); ?></th>
